...
def model(x_train, y_train, x_test, y_test, optimizer, batch_size):
...
if __name__ == "__main__":
    ...
    mnist_classifier = model(train_data, train_labels, eval_data, eval_labels, args.optimizer, args.batch_size)
